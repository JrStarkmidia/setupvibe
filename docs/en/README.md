...
| File | Used by |
|---|---|
| [`zshrc-macos.zsh`](../../conf/zshrc-macos.zsh) | desktop.sh on macOS |
| [`zshrc-linux.zsh`](../../conf/zshrc-linux.zsh) | desktop.sh on Linux |
...
A shared [`tmux.conf`](../../conf/tmux.conf) is downloaded and applied on both setups. For full documentation, keybinding reference, and plugin guide see **[tmux.md](tmux.md)**.
